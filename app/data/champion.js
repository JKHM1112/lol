...
for (const champion in champions.data) {
    let cham = champions.data[champion].name
    cham_name_kr.push(cham)
}
for (const champion in champions.data) {
    let cham = champions.data[champion].id
    cham_name_en.push(cham)
}
console.log(cham_name_kr, cham_name_en)